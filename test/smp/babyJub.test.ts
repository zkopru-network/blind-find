...
const g3 = new BabyJubPoint([
  BigInt("18261725078265092614434811797527239590734399126978701676813159791074850292972"),
  BigInt("538454765038134890313876770948423938647861892610414957151407612591625161882"),
]);
const g3Inverse = new BabyJubPoint([
  BigInt("3626517793574182607811593947730035497813965273437332666885044395500958202645"),
  BigInt("538454765038134890313876770948423938647861892610414957151407612591625161882"),
]);
const g3Squared = new BabyJubPoint([
  BigInt("514977334629920563682694145743151202274854875685861818727107193152252813031"),
  BigInt("975307299993603730749194759249385604570748703788292498705920558017605567278"),
]);
...
describe('exponentiate', () => {
  ...
  test('exponentiate negative integers', () => {
    expect(g3.exponentiate(BigInt(-2)).equal(g3.exponentiate(BigInt(2)).inverse())).toBeTruthy();
  });
});
